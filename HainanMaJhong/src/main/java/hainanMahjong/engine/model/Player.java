...
public class Player {
    ...
    public final List<Integer> hand = new ArrayList<>();   // 手牌（不含花牌），已排序
    public final List<Meld> melds = new ArrayList<>();         // 吃/碰/杠
    public final List<Integer> flowers = new ArrayList<>(); // 花牌
