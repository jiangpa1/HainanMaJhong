...
public class Action {
    ...
    public int priority() {
        switch (type) {
            case HU: return 0;
            case GANG: case AN_GANG: case BU_GANG: return 1;
            case PENG: return 2;
            case CHI: return 3;
            default: return 99;
        }
    ...
    public String toString() {
        switch (type) {
            case HU: return "胡(" + hainanjong.HuLib.cardName(targetTile) + ")";
            case PENG: return "碰(" + hainanjong.HuLib.cardName(targetTile) + ")";
            case GANG: return "杠(" + hainanjong.HuLib.cardName(targetTile) + ")";
            case AN_GANG: return "暗杠(" + hainanjong.HuLib.cardName(targetTile) + ")";
            case BU_GANG: return "补杠(" + hainanjong.HuLib.cardName(targetTile) + ")";
            case CHI: return "吃" + Arrays.toString(tiles);
            default: return "过";
        }
    }
}
