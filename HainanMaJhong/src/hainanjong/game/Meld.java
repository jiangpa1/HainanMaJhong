...
public class Meld {
    ...
    public String toString() {
        String name;
        switch (type) {
            case CHI: name = "吃"; break;
            case PENG: name = "碰"; break;
            case GANG: name = "明杠"; break;
            case AN_GANG: name = "暗杠"; break;
            default: name = "补杠"; break;
        }
        StringBuilder sb = new StringBuilder(name + "[");
        for (int i = 0; i < tiles.length; i++) {
            if (i > 0) sb.append(',');
            sb.append(hainanjong.HuLib.cardName(tiles[i]));
        }
        sb.append(']');
